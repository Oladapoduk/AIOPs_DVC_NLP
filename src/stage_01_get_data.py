...
STAGE = "stage one get data" ## <<< change stage name 
...
def main(config_path):
    ...
    local_data_dir_filepath = os.path.join(local_data_dir, data_filename)

    logging.info("Download started")
    filename, headers = req.urlretrieve(source_data_url, local_data_dir_filepath)
